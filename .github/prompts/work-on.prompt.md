---
description: Start the Work Workflow on a specific bead.
---
...
- This prompt expects a bead ID to be specified (either in $ARGUMENTS or in conversation context).

**Steps**
Track these steps as TODOs and complete them one by one.

1. **Identify the bead**
   - Extract bead ID from $ARGUMENTS or conversation
   - Verify it exists: `bd show <bead-id>`
   - If not specified or not found, ask user for the bead ID
